                ...
                <div class="col-lg-4 col-md-5 col-12">
                    ...
                    <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" id="password_confirmation" name="password_confirmation" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password Confirmation">
                                </div>
                            </div>
                        ...
                        <div class="text-center">
                            <p class="mt-15 mb-0 text-white">You want to login? <a href="{{ route('login') }}" class="text-info ml-5">Sign In</a></p>
                        </div>
                    </div>
                </div>
            </div>
